...
![Полный вид дашборда в Apache Superset](dashboard/screenshots/dashboard_full.png)

Скриншот показывает весь дашборд целиком: KPI-карточки, динамику по месяцам, сравнение участников по типам и форматам мероприятий, доходимость до завершения и таблицу детализации.
