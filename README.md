...
Следующий этап проекта - визуализация результатов в Apache Superset. Планируемый дашборд будет включать следующие графики:
...
7. На следующем этапе подключить таблицу `real_events` к Apache Superset.
